...
/*async*/ function run(data, pause) {
    for (var i in data) {
        bar.update(i, data[i]);
        if(data[i] == "A"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "B"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "C"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "D"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "E"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "F"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "G"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "H"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "I"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "J"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "K"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
        if(data[i] == "L"){M12.writeSync(1); sleep.msleep(pause-1); M12.writeSync(0); sleep.msleep(pause-1);}
